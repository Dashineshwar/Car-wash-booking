    ...
    <div class="form-section">
        ...
        <form id="address-form">
            <div class="form-group">
                ...
                <input type="text" id="address-line-1" name="address_line_1" class="form-control" value="<?= htmlspecialchars($user['address_line_1']) ?>" required>
            </div>
            <div class="form-group">
                <label for="address-line-2">Address Line 2</label>
                <input type="text" id="address-line-2" name="address_line_2" class="form-control" value="<?= htmlspecialchars($user['address_line_2']) ?>">
            </div>
            <div class="form-group">
    ...
    <div class="form-section">
        ...
        <form id="phone-form">
            <div class="form-group">
                ...
                <input type="text" id="phone-no" name="phone_no" class="form-control" value="<?= htmlspecialchars($user['phone_no']) ?>" required>
            </div>
