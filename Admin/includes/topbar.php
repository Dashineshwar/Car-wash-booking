...
$wallet_balance = 0; 
$query = "SELECT wallet FROM wallet WHERE id = '1'";
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ml-auto">
            ...
            <!-- Account Link -->
            <li class="nav-item">
                <a class="nav-link" href="admin_dashboard.php">All Bookings</a>
            </li>
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="accountDropdown">
                    ...
                    <a class="dropdown-item" href="manage_rider.php">Manage Riders</a>
                    <a class="dropdown-item" href="manage_admin.php">Manage Admins</a>
                </div>
            </li>
            <!-- Earnings Dropdown -->
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="accountDropdown">
                    <a class="dropdown-item" href="view_company_earnings.php">Company Earnings</a>
                    <a class="dropdown-item" href="view_riders_earnings.php">Riders Earnings</a>
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="accountDropdown">
                    <a class="dropdown-item" href="view_company_transactions.php">Company transactions</a>
                    <a class="dropdown-item" href="view_all_rider_transactions.php">Riders transactions</a>
